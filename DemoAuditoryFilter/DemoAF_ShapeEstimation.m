...
%% % plot results
   ...
   DemoAF_PrintFig([DirWork 'DemoAF_Fig7'],SwPrint);
   pause(1)
...
%% % plot Estimation points
   ...
   grid on;
   DemoAF_PrintFig([DirWork 'DemoAF_Fig6'],SwPrint);
...
%% % Impulse response of gammatone & gammachirp
   ...
   DemoAF_PrintFig([DirWork 'DemoAF_Fig12'],SwPrint);
...
%% % Frequency response of gammatone & gammachirp
   ...
   DemoAF_PrintFig([DirWork 'DemoAF_Fig13'],SwPrint);
