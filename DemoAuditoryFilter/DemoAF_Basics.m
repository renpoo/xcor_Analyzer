...
drawnow
hold off
DemoAF_PrintFig([DirWork 'DemoAF_Fig1'],SwPrint);
...
drawnow
hold off
DemoAF_PrintFig([DirWork 'DemoAF_Fig10'],SwPrint);
...
drawnow
hold off
DemoAF_PrintFig([DirWork 'DemoAF_Fig2'],SwPrint);
...
drawnow
DemoAF_PrintFig([DirWork 'DemoAF_Fig3'],SwPrint);
